...
def testlist():
    frm = Question('Ноутбук', 'Laptop', 'NoteBook', 'Computer', 'NoytByk')
    questions_listmodel.form_list.append(frm)
    frm = Question('Машина', 'Car', 'Mashina', 'MotoBike', 'Bus')
    questions_listmodel.form_list.append(frm)
    frm = Question('Людина', 'People', 'Peopli', 'Peple', 'Peolpe')
    questions_listmodel.form_list.append(frm)
    frm = Question('Телефон', 'Phone', 'TelePhone', 'Calling', 'Call')
    questions_listmodel.form_list.append(frm)
    frm = Question('Мабуть', 'Maybe', 'Maby', 'Mabyt', 'Maeby')
    questions_listmodel.form_list.append(frm)
    frm = Question('Пайтон', 'Python', 'Paiton', 'Pythan', 'Peithon')
    questions_listmodel.form_list.append(frm)
    frm = Question('Літак', 'Plane', 'Litak', 'FlyCar', 'Plena')
    questions_listmodel.form_list.append(frm)
    frm = Question('Програмування', 'Programming', 'TypingCode', 'Coder', 'Proger')
    questions_listmodel.form_list.append(frm)
    frm = Question('Стіл', 'Table', 'Stil', 'Tebla', 'Plane')
    questions_listmodel.form_list.append(frm)
    frm = Question('Вікно', 'Window', 'Windows', 'Vikno', 'Wendov')
    questions_listmodel.form_list.append(frm)
    frm = Question('Раковина', 'Sink', 'Rakovina', 'Senk', 'Sonk')
    questions_listmodel.form_list.append(frm)
def set_card():
